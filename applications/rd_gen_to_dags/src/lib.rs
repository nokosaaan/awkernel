...
const DAG_FILE_0: &str = concat!(
    include_str!("/home/nokosan/azumi-lab/RD-Gen/test/TU=3/DAGs/dag_0.yaml"),
    "\n"
);
const DAG_FILE_1: &str = concat!(
    include_str!("/home/nokosan/azumi-lab/RD-Gen/test/TU=1/DAGs/dag_1.yaml"),
    "\n"
);
